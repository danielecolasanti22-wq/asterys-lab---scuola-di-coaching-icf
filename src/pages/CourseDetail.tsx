    ...
    <div className="bg-white font-sans text-brand-navy antialiased overflow-x-hidden">
      ...
      <section className="relative bg-[#6FA8D6] overflow-hidden pb-6 lg:pb-0">
        <div className="max-w-[1200px] mx-auto px-4 sm:px-6 grid lg:grid-cols-[1.08fr_0.92fr] gap-0 lg:gap-10 items-end min-h-0 lg:h-[608px]">
          ...
          <div className="pt-12 lg:pt-14 pb-0 lg:pb-10 relative z-10 -mx-4 sm:-mx-6 px-4 sm:px-6 rounded-t-[2.6rem] lg:rounded-none bg-[#6FA8D6] lg:bg-transparent -mt-8 lg:mt-0 lg:self-start">
